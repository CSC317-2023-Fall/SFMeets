        ...
        document.querySelectorAll('button[class="view"]').forEach(button => {
            button.addEventListener('click', function () {
                const loadOrganization = async () => {
                    const organization = organizations.data.filter(organization => organization.NAME == button.parentElement.querySelector('span[class="organizationname"]').innerHTML)[0]
